...
In conjunction with the tutorial on [webscraping and APIs]('intermediate-skills-sessions/18-webscraping-apis/index.qmd'), below is a walkthrough of  the `fingertips_py` package maintained by the Department of Health and Social Care, which simplifies importing data via the Fingertips API.
