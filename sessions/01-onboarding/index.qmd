...
1. Suggest you install the Python and Jupyter *extension* offered by Microsoft - go ahead and do this. If this doesn't happen, you can install them manually from the *Extensions* pane on the left-hand side.
