...
This session discusses what it means to analyse relationships between variables, what is possible with different types of variables (and how this links to the previous session that looked at [comparing samples](/sessions/essential-skills/11-comparing-samples)), and what these methods can and cannot tell us.
...
For more information about Pearson's $r$, check out this [blog post](https://hodausama.github.io/posts/PearsonsR/) by Hoda Osama.
