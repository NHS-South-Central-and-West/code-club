...
# Building Models for the Real World {data-background-color="#425563"}
...
- But real-world machine learning is much messier:
    ...
    - Choosing and creating the right features
    - Validating performance honestly
    - Avoiding common traps
- Today we tackle the real workflow.
...
## Each Step Includes Complexity {.center}
...
- But it is also where the most value can be derived. There is usually bigger gains in careful feature engineering than spending hours fine-tuning a complex algorithm.
