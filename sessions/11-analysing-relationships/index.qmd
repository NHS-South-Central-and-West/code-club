...
```{python}
#| label: flipper-mass-scatter-plot
...
```{python}
#| label: flipper-mass-regression-plot
...
These plots points to another limitation with Pearson's *r* that also applies to regression plots. Grouping structures!

```{python}
#| label: grouping-structures
