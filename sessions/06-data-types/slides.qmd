...
<figure style="display: flex; flex-direction: column; align-items: center; margin: 0;">
  <img src="images/data-types-overview.png" />
  <figcaption style="margin-top: 0.1em; line-height: 1.2;">A logical overview of the basic data types in python. From geeksforgeeks.org/python-data-types
</figcaption>
</figure>
